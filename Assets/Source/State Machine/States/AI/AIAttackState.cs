...
public class AIAttackState : AIBaseLocomotionState
{
    ...
    public override void Tick()
    {
        ...
        if (base.Get<WeaponController>().CanFire && reactionTimer >= reactionSpeed)
            base.Get<WeaponController>().Fire(base.Pawn.CanSeeTarget ? base.Pawn.Target.FocusPoint.position : base.Pawn.LastKnownPositionOfTarget + Vector3.up * 1.5f, base.Actor.ActualInput.magnitude);
    }
